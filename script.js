...
function Ubicación(stringLocalidad){
    ...
    ["engativa","Noroccidente de la ciudad-------Técnicos: Luis Angarita, Alexander Lopéz, Andrés Ariza, Oscar Caceres, Diego Alba, Fabian Ruiz, Felipe Diaz, Javier Mendivelso"],
    ["barrios unidos","Norte de la ciudad"],["chapinero","Norte de la ciudad"],
    ["teusaquillo","Centro de la ciudad"],["fontibon","Centroccidente de la ciudad-------Técnicos: Andrés Gary"],["la candelaria","Centro"],["santa fe","Centro"],
